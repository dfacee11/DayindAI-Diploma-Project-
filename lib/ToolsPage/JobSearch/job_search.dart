...
class _JobSearchPageState extends State<JobSearchPage> {
  ...
  String _selectedArea = '160'; // Kazakhstan default
  ...
  Future<void> _search() async {
    ...
    try {
      ...
      final response = await http.get(
        uri,
        headers: {
          'User-Agent': 'DayindAI/1.0 (support@dayindai.app)',
        },
      ...
      setState(() {
        _error = 'Нет соединения. Проверьте интернет.';
        _isLoading = false;
      });
    }
  }
  ...
  Color _salaryColor(Map<String, dynamic>? salary) {
    if (salary == null) return const Color(0xFF94A3B8);
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            langCode == 'ru' ? 'Данные из HH.ru' : 'Powered by HH.ru',
            style: GoogleFonts.montserrat(fontSize: 12, fontWeight: FontWeight.w500, color: const Color(0xFF94A3B8)),
          ),
        ],
      ),
    );
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(_error!, style: GoogleFonts.montserrat(fontSize: 14, fontWeight: FontWeight.w600, color: const Color(0xFFEF4444))),
        ],
      ),
    );
  }

  Widget _buildNoResults(String langCode) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
  ...
  Widget _buildResults(String langCode) {
    return Column(
      children: [
        // Results count
        Padding(
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  'HH.ru',
                  style: GoogleFonts.montserrat(fontSize: 11, fontWeight: FontWeight.w800, color: const Color(0xFFEF4444)),
                ),
              ),
            ],
          ),
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              employer,
                              style: GoogleFonts.montserrat(fontSize: 12, fontWeight: FontWeight.w600, color: const Color(0xFF7C5CFF)),
                            ),
                          ),
                        ],
                      ),
